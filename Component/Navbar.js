...
(function () {
  ...
  const STEPS = [
    ...
    { icon: '📝', title: 'Questionnaires',          text: 'Create exams with multiple parts — Multiple Choice, True or False, Identification, and Essay. Import a .json file to auto-fill from a saved questionnaire, or import questions from the Test Bank.' },
    { icon: '✅', title: 'Answer Keys',             text: 'Answer keys are auto-generated for non-essay parts when you save a questionnaire. They are view-only and used by the scanner to grade student papers.' },
