...
<aside class="sidebar">
  ...
  <div class="sidebar-qr">
    ...
    <a href="https://darylpaul.github.io/thesis-mobile" target="_blank" rel="noopener noreferrer">
      <img
        src="https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=https://darylpaul.github.io/thesis-mobile"
        alt="Scan to open mobile app"
        class="sidebar-qr-img"
      />
    </a>
    <div class="sidebar-qr-caption">Scan or <a href="https://darylpaul.github.io/thesis-mobile" target="_blank" rel="noopener noreferrer" class="sidebar-qr-link">click here</a> to open<br>the mobile scanner</div>
  </div>
</aside>
`;
